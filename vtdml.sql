...
--
-- Client :  localhost
-- Généré le :  Mar 02 Mai 2023 à 00:37
...
CREATE TABLE `characters` (
  `namechar` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `gender` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
  `age` int(11) NOT NULL,
  `birthday` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `franchise` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `groups` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `typechar` varchar(50) COLLATE utf8_unicode_ci NOT NULL
...
CREATE TABLE `entertainment` (
  `nameentertainmenent` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `typeentertainement` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `franchise` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `familiar` (
  `namefamiliar` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `typefamiliar` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `namechar` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Contenu de la table `familiar`
--
...
CREATE TABLE `friends` (
  `namechar` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `namefriend` text COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Contenu de la table `post_topic`
--
...
(4, 'Vanessa', 'A', 'Vanessa A', 'vanessa.a@gmail.com', 1, '$2y$10$NxyfIE.bxjnbZ7rTS.7d9eUP2wezbWQkMJKVWQ4rsAN5swvz14VXq'),
(5, 'Antoine', 'M', 'Toinou', 'antoine.m@gmail.com', 0, '$2y$10$OyNZZfrfszmb.75SZWssj.bFU0sqqoesfio7IafbuIzpZCxR95Sfa'),
